...
320px lobby containment, the active-hand exit boundary, invite-copy fallback
feedback, and display preferences. It does not inspect PostgreSQL to advance a
game.
